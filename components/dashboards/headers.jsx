...
const Header = () => {
  return (
    ...
    h-16 flex items-center justify-between px-8 border-b border-gray-200/50 shadow-sm">
      {/* Gradient overlay for depth */}
      <div className="absolute inset-0 bg-gradient-to-r from-blue-50/30 
      via-transparent to-purple-50/30 pointer-events-none"></div>
      ...
      <div className="relative flex items-center gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            hover:bg-gray-100/80 transition-all duration-200 hover:scale-105 active:scale-95" 
          ...
          >
            ...
            from-blue-400 to-purple-400 rounded-full opacity-0 
            group-hover:opacity-75 blur-md transition-opacity duration-300"></div>
            <div className="relative ring-2 ring-gray-200
             group-hover:ring-blue-400 rounded-full transition-all duration-200 hover:scale-110">
              <Image
          ...
          <button 
            ...
            className="group p-2.5 rounded-xl hover:bg-gray-100/80 transition-all duration-200 hover:scale-105 active:scale-95 relative overflow-hidden"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/0 to-indigo-500/10
      ...
      h-px bg-gradient-to-r from-transparent via-blue-200 to-transparent"></div>
    </div>
  );
};  
